        ...
        <main className="button-section">
          ...
          <div>
            ...
            <ul className="UL">
              ...
              >
                What rewards will I earn by completing the New Seller
                Challenges?
              </li>
              <li
                style={{
            ...
            <ul className="UL">
              ...
              >
                What is Shipping Fee (Charged by Daraz) and Shipping Fee (Paid
                by Customer)?
              </li>
              <li
                style={{
          ...
          <div>
            ...
            <ul className="UL">
              ...
              >
                How much commission will be charged and how can it be
                calculated?
              </li>
              <li
                style={{
